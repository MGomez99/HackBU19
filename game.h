...
//namespace game{
    class GameBoard{
        public:
            ...
            vect2d modBoard(std::tuple<int, int> start, std::tuple<int, int> end, vect2d board, int isTemp); //modifies board and returns it
            ...
            vect2d getTemp(){ return this->temp;}
            void setTemp(vect2d temp){this->temp = temp;}
